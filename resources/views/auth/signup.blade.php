...
<x-layout title="Signup">
    ...
    <div class="flex items-center h-screen justify-center px-4">
        <div class="flex flex-col md:flex-row w-full md:w-2/3 md:h-[420px] shadow-xl rounded-xl">
            ...
            <div id="form" class="w-full flex flex-col">
                <form class="flex flex-col w-full gap-2 p-8">
                    ...
                    <label class="input input-bordered flex items-center gap-2">
                        ...
                        <input name="name" class="grow" placeholder="Enter your Name"/>
                    </label>
                    ...
                    <label class="input input-bordered flex items-center gap-2 password-group">
                        ...
                        <input name="password_confirmation" type="password" class="grow"
