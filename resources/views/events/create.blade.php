<x-layout title="Create Organization" :show_navbar="true" :show_heading="true">
    ...
    <form class="p-6 lg:p-8" method="POST" action="/events">
        @csrf

        <div>
            <h2 class="text-base/7 font-semibold text-gray-900">Create an Event</h2>
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <a type="button" class="btn" href="/events">Cancel</a>
